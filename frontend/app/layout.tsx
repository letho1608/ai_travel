...
export const metadata = { title: "Mình Đi Đâu Thế", description: "Một kế hoạch Hà Nội vừa vặn, không cần mở mười tab.", icons: { icon: "/brand/favicon.png", apple: "/brand/favicon.png" } };
